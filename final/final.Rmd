...
All data, code, and analysis materials related to this assignment can be obtained at:
...
We create a few dummy variables that will be helpful during our regression analysis, particularly for the covariates of interest in this study: gender (is the participant male?), age (is the participant over 30?), and education (does the participant hold a Bachelors or higher degree?). 
...
To investigate the remaining hypotheses, we begin by investigating the "inclusive" model, which reports the more conservative effect size. Should any of the models produce significant results, the "exclusive" model can also be generated to produce extreme value bounds estimates of the effect size.
...
The two levels of treatment report very similar effects, with a great deal of overlap between their respective confidence intervals. The confidence interval for the moderate treatment effect is () and the confidence interval for the strong treatment effect is (`r `, `r `). If there were a significant difference between these two value, we would expect to see no overlap between the intervals, but in fact we do.

We therefore fail to reject the null hypothesis that there is any difference in the effect of the moderate treatment and the strong treatment.
...
The coefficient for the term interacting males with the treatment has a p-value of `r `, and is not a significant result. Thus, we also fail to reject the null hypothesis that there is no difference in the effect among males and females.
...
The coefficient for the term interacting 4-year college degree holders with the treatment has a p-value of `r `, and is not a significant result. We fail to reject the null hypothesis that there is no difference in the effect between participants with or without 4-year degrees.


#Hypothesis 5#

_Participants whose age is over 30 years old who receive the treatment will be more likely to answer IDK than those aged 30 years or younger._
...
The coefficient for the term interacting participants aged over 30 with the treatment has a p-value of `r `, and is not a significant result. And finally, we fail to reject the null hypothesis that there is no difference in effect between those whose age is over 30 and those who are 30 and under.


# Manipulation Check

As a sanity check on treatment delivery, we also test the assignment of participants to treatment and control groups.
